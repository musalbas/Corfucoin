...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa1f040d9e2d577f7fb5026841b68ad2101ff777eecc4383579976ab4e06efa4c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("5497c0b6149ac7a846ae80e1d63623a6f1176c34832f072dc45d9d5261051727c13310f6f96a0df4c707f860fc21c40f0bd3590333094d4d537d922ebb6090ed8d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1460159123;
        block.nBits    = 504365644;
        block.nNonce   = 2100286412;

        if (fTestNet)
        {
            block.nTime    = 1460159123;
            block.nNonce   = 2097616640;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6aacaaf0f42a65ec7c98d15262556cf9f7235294cf8510cc5c49f9105d340924"));
        block.print();
