...
uint256 hashGenesisBlock("0x2706e9bba710e55833c14b58e4cd9a2c592cfbb8bb1c943e6978281044900dc2");
...
const string strMessageMagic = "Corfucoin Signed Message:\n";
...
{
    // Corfucoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Corfucoin: 840k blocks in ~4 years
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Corfucoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::AddToBlockIndex(CValidationState &state, const CDiskBlockPos &pos)
{
    ...
    if (pindexNew == pindexBest)
    {
        ...
        static uint256 hashPrevCorfucoinBase;
        UpdatedTransaction(hashPrevCorfucoinBase);
        hashPrevCorfucoinBase = GetTxHash(0);
    }
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Corfucoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Corfucoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x71bbe0d2c046973c4148fae3bddb24aad87eea8ac98d323ed0c06693d70eab66");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Corfu, May 30 - June 02 2016";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4ab2a8b3f5ecc60f08bdebe97235bc3794e5fe6a23d82b4a473664ccc26c892b6e802680baabf2a52753401ed3ce1fffaf1bcdff21dd7d95bae20308c7f35b6102") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1463959997;
        block.nBits    = 504365644;
        block.nNonce   = 1397797352;

        if (fTestNet)
        {
            block.nTime    = 1463959997;
            block.nNonce   = 2428878161;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x53aaad15904757b319019146c72b4aa50ebf22385a8814366e481913f8f68f94"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Corfucoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CorfucoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CorfucoinMiner : ProcessBlock, block not accepted");
    }
